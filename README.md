...
xZune.Vlc is a LibVlc library for DotNet,we pack many functions of LibVlc.The project is mainly to find a perfect solution
 for Vlc on WPF.xZune.Vlc has a WPF Control,this control use the InteropBitmap and Shared memory to display video,it's a native WPF Control.So it has no airspace issues.
...
01.Add the references of xZune.Vlcin your project.
```
xZune.Vlc.dll
xZune.Vlc.Wpf.dll
```
