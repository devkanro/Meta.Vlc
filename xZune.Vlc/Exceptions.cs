...
namespace xZune.Vlc
{
    ...
    public class NoLibVlcFunctionAttributeException : LibVlcException
    {
        ...
        /// </summary>
        public NoLibVlcFunctionAttributeException() : base("For LibVlcFunction, need LibVlcFunctionAttribute to get Infomation of function.")
        {
    ...
    /// <summary>
    /// If a function can't be found in LibVlc dlls, this exception will be throwed, maybe we should check the LibVlc version what the function need.
    /// </summary>
    public class FunctionNotFoundException : LibVlcException
    {
        ...
        public FunctionNotFoundException(LibVlcFunctionAttribute functionInfo, LibVlcVersion libvlcVersion) : this(functionInfo, libvlcVersion , null)
        {
        }

        /// <summary>
        /// Create a  <see cref="FunctionNotFoundException"/> with function's infomation, LibVlc's version and a inner exception. 
        /// </summary>
        /// <param name="functionInfo">infomation of function</param>
        /// <param name="libvlcVersion">version of LibVlc</param>
        /// <param name="innerException">inner exception</param>
        public FunctionNotFoundException(LibVlcFunctionAttribute functionInfo, LibVlcVersion libvlcVersion,Exception innerException) : base(String.Format("Can't find function \"{0}\" in dll.", functionInfo.FunctionName), innerException)
        {
    ...
    public class FunctionNotAvailableException : LibVlcException
    {
        ...
        /// <param name="functionInfo">infomation of function</param>
        /// <param name="libvlcVersion">version of LibVlc</param>
        public FunctionNotAvailableException(LibVlcFunctionAttribute functionInfo, LibVlcVersion libvlcVersion) : base(String.Format("Function \"{0}\" isn't available on current version LibVlc.", functionInfo.FunctionName))
        {
            FunctionInfomation = functionInfo;
            LibVlcVersion = libvlcVersion;
        }
    ...
    /// <summary>
    /// If some exception throwed when loading LibVlc, this exception will be throwed, maybe you should check the LibVlc target platform and your app target platform.
    /// </summary>
    public class LibVlcLoadLibraryException : LibVlcException
    {
        ...
        public LibVlcLoadLibraryException(Exception innerException)
            : base("Can't load LibVlc dlls, check the platform and LibVlc target platform (should be same, x86 or x64).", innerException)
        {
