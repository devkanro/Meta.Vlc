...
namespace xZune.Vlc.Interop.MediaPlayer
{
    ...
    /// <returns>A NULL-terminated linked list of potential audio output devices. It must be freed with <see cref="ReleaseAudioDeviceList"/></returns>
    ...
    /// </summary>
    /// <param name="mediaPlayer">media player </param>
    /// <param name="module">If NULL, current audio output module. if non-NULL, name of audio output module (<see cref="AudioOutput.Name"/>)</param>
    ...
    /// </summary>
    /// <param name="mediaPlayer">media player </param>
    /// <returns>the current audio output device identifier NULL if no device is selected or in case of error (the result must be released with <see cref="Free"/>). </returns>
