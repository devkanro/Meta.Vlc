...
namespace xZune.Vlc.Interop.VLM
{
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate int NewBroadCastInput(IntPtr instance, IntPtr broadcastName, IntPtr inputMRL, IntPtr outputMRl, int options, IntPtr IntPtrOptions, int boolNewBorodcast, int ifLoopBroadcast);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate int NewVodInput(IntPtr instance, IntPtr mediaWork, IntPtr inputMRL, int numberOptions, IntPtr addOptions, int boolNewVod, IntPtr vodMuxer);
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    public delegate int EditMediaParas(IntPtr instance, IntPtr newBroadcastName, IntPtr inPutMRL, IntPtr outPutMRL, int numberOptains, IntPtr addOptains, int boolNewBroadcast, int ifLoopBroadcast);
